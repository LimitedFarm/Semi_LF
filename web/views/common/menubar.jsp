...
<body style="height:1500px">
	...
	<div id="loginDiv" class="modal" >
		<div class="modal-dialog modal-dialog-centered" style="width:400px;">
        	...
        	<div class="modal-body" style="padding:30px;">
        		<form id="loginInfo">
          			<table class="table-borderless" >
          				...
          				<tr>
          					<td>비밀번호</td>
          					<td><input type="password" id="loginPwd" name="loingPwd"></td>
          				</tr>
          				<tr>
        	...
        	<button id="loginConnect" type="button" class="btn btn-success">로그인</button>
	...
	<script>
		...
		$(document).click(
				function(event) { // 메뉴바를 제외한 부분 클릭시 메뉴바 닫힘
