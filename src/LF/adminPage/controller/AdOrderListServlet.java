...
/**
 * Servlet implementation class AdOrderList
 */
@WebServlet("/orderPList.ad")
public class AdOrderListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdOrderListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 일반 회원의 정보를 가져온다.
		ArrayList<AdOrderList> orderList = aService.selectOrdertList(currentPage, limit);
		RequestDispatcher views = null;
		if(listCount >=0) {
			views = request.getRequestDispatcher("views/admin/orderPListManager.jsp");
