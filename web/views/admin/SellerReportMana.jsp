...
<body>
	<div class="divAlign">
		...
		<div style="text-align:center; width:1000px;">
			<% for(int i=0; i<10; i++) {%>
				<form class="borderOut form-inline" id="reportList<%=i %>" style="align:center; margin:10px; ">
					<input type="hidden" value="판매자 번호">
					<table class="table table-borderless"style="width: 1000px; min-width:1000px;">
						<tr>
							<td>신고 번호</td>
							<td width="50px"><input class="form-control" type="text" value="신고 번호" readonly></td>
							<td>신고자 아이디</td>
							<td width="50px"><input class="form-control" type="text" value="임시" readonly></td>
							<td><button type="button" class="btn btn-primary">상품으로 가기</button> 
						</tr>
						<tr>
							<td>물품 이름</td>
							<td colspan=2><input class="form-control" type="text" value="바나나나나" readonly></td>
							<td>신고 날짜</td>
