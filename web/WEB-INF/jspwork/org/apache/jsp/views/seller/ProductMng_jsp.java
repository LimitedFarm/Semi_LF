 ...
 * Generated at: 2019-10-26 04:39:35 UTC
...
for(pList p : list){ 
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\talert(\"scroll\");\r\n");
      out.write("\t\t\t\tcurrentPage++;\r\n");
      out.write("\t\t\t\tconsole.log(sid, currentPage);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/prMngRoad.prod\",\r\n");
      ...
      out.write("\t\t\t\t\t\talert(sid, currentPage);\r\n");
      out.write("\t\t\t\t\t\tconsole.log(\"before\");\r\n");
      out.write("\t\t\t\t\t}, */\r\n");
      out.write("\t\t\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\t\t\talert(\"clear\");\r\n");
      out.write("\t\t\t\t\t\tconsole.log(\"clear\");\r\n");
      out.write("\t\t\t\t\t\tfor(var key in data){\r\n");
      out.write("\t\t\t\t\t\t//값 받아오는거는 for문 돌리든 해서 넣기.\r\n");
      out.write("\t\t\t\t\t\tvar pName = data[key].pName;\r\n");
      out.write("\t\t\t\t\t\tvar pPrice = data[key].pPrice;\r\n");
      out.write("\t\t\t\t\t\tvar pCount = data[key].pCount;\r\n");
      out.write("\t\t\t\t\t\tvar createDate = data[key].createDate;\r\n");
      out.write("\t\t\t\t\t\tvar pPeriod = data[key].pPeriod;\r\n");
      out.write("\t\t\t\t\t\tvar pContent = data[key].pContent;\r\n");
      out.write("\t\t\t\t\t\t$(\".tableArea\").append(\"<hr><table id='productTable' align='center' width='90%' border='1px solid black' style='border-collapse:collapse'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+ \"<tr><td rowspan='5' width='20%' height='30%'>\" \r\n");
      out.write("\t\t\t\t\t\t\t\t+ \"<div align='center' border='1px solid black'>image</div></td>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+ \"<td rowspan='1' width='65%'>상품명 : \" + pName + \"</td>\"\r\n");
